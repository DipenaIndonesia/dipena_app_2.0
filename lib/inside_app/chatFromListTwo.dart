...
// import 'package:dipena_full/inside_app/testRealTimeChat.dart';
// import 'package:dipena_full/model/chatData.dart';
// import 'package:dipena_full/model/listChat.dart';
// // import 'package:dipena_full/model/seeDeals.dart';
// import 'package:flutter/material.dart';
// import 'package:http/http.dart' as http;
// import 'package:shared_preferences/shared_preferences.dart';

// class ChatFromListTwo extends StatefulWidget {
//   final ListChat model;
//   ChatFromListTwo(this.model);
//   @override
//   ChatFromListTwoState createState() => ChatFromListTwoState();
// }

// class ChatFromListTwoState extends State<ChatFromListTwo> {
...
//         .post("http://dipena.com/flutter/api/chat/sendMessage.php", body: {
//       "user_id": user_id,
...
//   // var loadingg = false;
//   // final listTwo = new List<ChatContentTwo>();
//   // Future<void> _chatContentTwo() async {
//   //   await getPref();
//   //   list.clear();
//   //   setState(() {
//   //     loading = true;
//   //   });
//   //   final response =
//   //       await http.post("https://dipena.com/flutter/api/chat/selectChatTwo.php",
//   //   body: {
//   //     "user_id": user_id,
...
//                   // listTwo.isEmpty ? Center(child: Text("CHAT KOSONG"),) :
//                   // ListView.builder(
//                   //   shrinkWrap: true,
//                   //     physics: const NeverScrollableScrollPhysics(),
...
class ChatFromListTwo extends StatefulWidget {
  ...
  ChatFromListTwo(this.model);
  @override
  _ChatFromListTwoState createState() => _ChatFromListTwoState();
}

class _ChatFromListTwoState extends State<ChatFromListTwo> {
  final GlobalKey<RefreshIndicatorState> _refresh =
      GlobalKey<RefreshIndicatorState>();
  final GlobalKey<RefreshIndicatorState> _refreshChat =
      GlobalKey<RefreshIndicatorState>();
