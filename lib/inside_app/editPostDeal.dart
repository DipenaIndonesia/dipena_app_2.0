...
class EditPostDeals extends StatefulWidget {
  final SeeDeals model;
  final VoidCallback reload;
  EditPostDeals(this.model, this.reload);
  @override
  _EditPostDealsState createState() => _EditPostDealsState();
}

class _EditPostDealsState extends State<EditPostDeals> {
  String user_id,
      post_user_id,
      post_cat_id,
      post_sub_cat_id,
