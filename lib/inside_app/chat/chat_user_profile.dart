...
class ChatUserProfile extends StatefulWidget {
  ...
  // ChatUserProfile(this.model);
  final String user_chat_id;
  ChatUserProfile(this.user_chat_id);
  @override
...
class _ChatUserProfileState extends State<ChatUserProfile> {
  ...
  String user_id, chat_content, user_fullname, user_username, user_img;
  getPref() async {
  ...
  submit() async {
    if (_imageFile == null) {
      ...
      final response = await http
        ...
        "user_id": user_id,
        "user_id_two": widget.user_chat_id,
        "chat_content": chat_content,
      });
    ...
    try {
      ...
      request.fields['user_id_two'] = widget.user_chat_id;
  ...
  Future fetchPost() async {
    ...
    final response = await http
      ...
      "user_id": user_id,
      "post_user_id": widget.user_chat_id,
