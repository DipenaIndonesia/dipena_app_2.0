...
// import 'package:dipena_full/model/commentData.dart';
// import 'package:dipena_full/model/post.dart';
// import 'package:dipena_full/model/selectPostFollow.dart';
// import 'package:dipena_full/url.dart';
// import 'package:flutter/material.dart';
// import 'package:http/http.dart' as http;
// import 'package:shared_preferences/shared_preferences.dart';

// class CommentFromHome extends StatefulWidget {
//   // final VoidCallback reload;
//   final PostFollow model;
//   CommentFromHome(this.model);
//   @override
//   _CommentFromHomeState createState() => _CommentFromHomeState();
// }

// class _CommentFromHomeState extends State<CommentFromHome> {
...
//         .post(CommentUrl.addComment, body: {
//       "user_id": user_id,
...
class _CommentFromHomeState extends State<CommentFromHome> {
  ...
  Widget build(BuildContext context) {
    var placeholder = CircleAvatar(
         minRadius: 25, backgroundImage: AssetImage('./img/placeholder.png'));
    return Scaffold(
        //  PreferredSize(
        //       preferredSize: Size.fromHeight(62),
        //       child:
