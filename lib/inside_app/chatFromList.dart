...
// class ChatFromList extends StatefulWidget {
//   final ListChat model;
//   ChatFromList(this.model);
//   @override
//   ChatFromListState createState() => ChatFromListState();
// }

// class ChatFromListState extends State<ChatFromList> {
...
class ChatFromList extends StatefulWidget {
  ...
  ChatFromList(this.model);
  @override
  _ChatFromListState createState() => _ChatFromListState();
}

class _ChatFromListState extends State<ChatFromList> {
  final GlobalKey<RefreshIndicatorState> _refresh =
      GlobalKey<RefreshIndicatorState>();
  final GlobalKey<RefreshIndicatorState> _refreshChat =
      GlobalKey<RefreshIndicatorState>();
  ...
  submit() async {
    if (_imageFile == null) {
      ...
      final response = await http
        ...
        // "chat_content": chat_content,
        "user_id": user_id,
      "user_id_two": widget.model.chat_user_two,
      "chat_content": chat_content,
      });
      final data = jsonDecode(response.body);
      int value = data['value'];
    ...
    try {
      ...
      final request = http.MultipartRequest("POST", uri);
      request.fields['user_id'] = user_id;
      request.fields['user_id_two'] = widget.model.chat_user_two;
