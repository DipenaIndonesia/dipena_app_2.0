...
class UserListCollabs extends StatefulWidget {
  @override
  _UserListCollabsState createState() => _UserListCollabsState();
}

class _UserListCollabsState extends State<UserListCollabs> {
  @override
